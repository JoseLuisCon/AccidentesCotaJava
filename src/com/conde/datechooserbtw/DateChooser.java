package com.conde.datechooserbtw;

import com.formdev.flatlaf.FlatClientProperties;
import com.formdev.flatlaf.extras.FlatSVGIcon;
import com.formdev.flatlaf.util.UIScale;
import com.conde.datechooserbtw.layout.CellLayout;
import com.conde.datechooserbtw.layout.HeaderLayout;
import com.conde.datechooserbtw.listener.DateChooserAction;
import com.conde.datechooserbtw.listener.DateChooserListener;
import com.conde.datechooserbtw.render.DateChooserRender;
import com.conde.datechooserbtw.render.DefaultDateChooserRender;
...
public class DateChooser extends JPanel {
    ...
    private DateSelectionMode dateSelectionMode = DateSelectionMode.BETWEEN_DATE_SELECTED;
    private JPopupMenu popup;
    private JTextField textField;
    private JButton labelCurrentDate;
    private String betweenCharacter = " a ";
...
//            return new String[]{"January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
            return new String[]{"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Augusto", "Septiembere", "Octubre", "Noviembre", "Diciembre"};
        } else {
            return months;
        }
    }
...
//            return new String[]{"Sun", "Mon", "Tue", "Wed", "Thu", "Fir", "Sat"};
    ...
    private void createHeader() {
        ...
        panelHeader.putClientProperty(FlatClientProperties.STYLE, "" +
                "background:if($DateChooser.background,$DateChooser.background,$Panel.background)");
        JButton cmdBack = new JButton(new FlatSVGIcon("com/conde/resources/icons/arrowCollapse.svg"));
        JButton cmdNext = new JButton(new FlatSVGIcon("com/conde/resources/icons/arrowExpand.svg"));
